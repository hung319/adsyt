...
async def pair_device():
    try:
        lounge_controller = ytlounge.YtLoungeApi("SkipAdsTV")
        ...
        if not paired:
            print("Liên kết thất bại, vui lòng nhập mã mới nhất và thử lại")
            return
        device = {
        ...
        print(f"Liên kết thất bại: {e}")
        return


def main(config, debug: bool) -> None:
    print("Welcome to the SkipAdsTV cli setup wizard")
